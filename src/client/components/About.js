...
export default function About() {
  return (
    <>
      ...
      <p>
        Our History, Values In Action, Leadership Team, Investor Relations, News
        andp//#endregion Notifications, Franchise Info.
      </p>
      <h2 id="careers">
        <a>Careers</a>
      </h2>
      ...
      <p>
        Gift Card FAQs Donations Employment Restaurant Feedback Frequently Asked
        Questions
      </p>
      <h2 id="accessibility">
        <a>Accessibility</a>
      ...
      <p>
        is nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
